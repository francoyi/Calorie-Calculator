...
public class MealDialog extends JDialog {
    ...
    private void onSave() {
        ...
        for (MealRow r : tableModel.getRows()) {
    ...
    private class MealTableModel extends AbstractTableModel  {
        ...
        public boolean isCellEditable(int r, int c) {
            // allow editing for all columns so the fetch button (col 4) can be clicked
            return true;
        }
        ...
        public Object getValueAt(int r, int c) {
            ...
            switch (c) {
                ...
                case 2:
                    return row.unit;
                case 3:
                    return (row.kcalManual == null) ? "" : String.format("%.1f", row.kcalManual);
        ...
        public void setValueAt(Object aValue, int r, int c) {
            ...
            switch (c) {
                case 0:
                    row.item = String.valueOf(aValue).trim();
                    break;
                case 1:
                    try {
